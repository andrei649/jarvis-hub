...
![Backend tests](https://img.shields.io/badge/backend_tests-6933-brightgreen?logo=pytest)
...
Generated test matrix: backend **6,933** · frontend **627** · mobile **103**. Route surface: **427**.
...
Generated status: **v1.0.0** · backend **6,933** · frontend **627** · mobile **103** · **427** routes · **18** active agents · open release gates: **A1, A3, A5, A6, A9** · source commit `02fc0624258a`. Full data: [`project-status.json`](project-status.json).
