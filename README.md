...
![Backend tests](https://img.shields.io/badge/backend_tests-4938-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,938** · frontend **236** · mobile **87**. Route surface: **396**.
...
Generated status: **v0.11.0** · backend **4,938** · frontend **236** · mobile **87** · **396** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `d3d98761457b`. Full data: [`project-status.json`](project-status.json).
