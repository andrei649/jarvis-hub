...
![Backend tests](https://img.shields.io/badge/backend_tests-7219-brightgreen?logo=pytest)
...
Generated test matrix: backend **7,219** · frontend **923** · mobile **110**. Route surface: **442**.
...
Generated status: **v1.0.0** · backend **7,219** · frontend **923** · mobile **110** · **442** routes · **18** active agents · open release gates: **A1, A3, A5, A6, A9** · source commit `fc43e7b060f8`. Full data: [`project-status.json`](project-status.json).
