...
![Backend tests](https://img.shields.io/badge/backend_tests-6813-brightgreen?logo=pytest)
...
Generated test matrix: backend **6,813** · frontend **521** · mobile **96**. Route surface: **405**.
