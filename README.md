...
![Backend tests](https://img.shields.io/badge/backend_tests-4636-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,636** · frontend **227** · mobile **70**. Route surface: **382**.
...
Generated status: **v0.11.0** · backend **4,636** · frontend **227** · mobile **70** · **382** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `42c6818261ad`. Full data: [`project-status.json`](project-status.json).
