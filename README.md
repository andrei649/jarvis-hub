...
![Backend tests](https://img.shields.io/badge/backend_tests-6377-brightgreen?logo=pytest)
...
Generated test matrix: backend **6,377** · frontend **515** · mobile **96**. Route surface: **405**.
...
Generated status: **v0.11.0** · backend **6,377** · frontend **515** · mobile **96** · **405** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `7491908e7896`. Full data: [`project-status.json`](project-status.json).
