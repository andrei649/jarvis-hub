...
![Backend tests](https://img.shields.io/badge/backend_tests-4231-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,231** · frontend **208** · mobile **55**. Route surface: **368**.
...
Generated status: **v0.11.0** · backend **4,231** · frontend **208** · mobile **55** · **368** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `09ffb342e3f3`. Full data: [`project-status.json`](project-status.json).
