...
![Backend tests](https://img.shields.io/badge/backend_tests-4368-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,368** · frontend **209** · mobile **55**. Route surface: **375**.
...
Generated status: **v0.11.0** · backend **4,368** · frontend **209** · mobile **55** · **375** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `cfd4f1198c61`. Full data: [`project-status.json`](project-status.json).
