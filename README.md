...
![Backend tests](https://img.shields.io/badge/backend_tests-4285-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,285** · frontend **209** · mobile **55**. Route surface: **369**.
...
Generated status: **v0.11.0** · backend **4,285** · frontend **209** · mobile **55** · **369** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `f7b7d15fc8a9`. Full data: [`project-status.json`](project-status.json).
