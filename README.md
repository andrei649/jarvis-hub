...
![Backend tests](https://img.shields.io/badge/backend_tests-5214-brightgreen?logo=pytest)
...
Generated test matrix: backend **5,214** · frontend **370** · mobile **96**. Route surface: **400**.
...
Generated status: **v0.11.0** · backend **5,214** · frontend **370** · mobile **96** · **400** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `4d27fec81cdf`. Full data: [`project-status.json`](project-status.json).
