...
![Backend tests](https://img.shields.io/badge/backend_tests-4776-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,776** · frontend **231** · mobile **77**. Route surface: **386**.
...
Generated status: **v0.11.0** · backend **4,776** · frontend **231** · mobile **77** · **386** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `cc4542f888db`. Full data: [`project-status.json`](project-status.json).
