...
![Backend tests](https://img.shields.io/badge/backend_tests-11310-brightgreen?logo=pytest)
...
Generated test matrix: backend **11,310** · frontend **1,313** · mobile **140**. Route surface: **501**.
...
Generated status: **v1.0.0** · backend **11,310** · frontend **1,313** · mobile **140** · **501** routes · **18** active agents · open release gates: **A1, A3, A4, A6** · backlog: **289 done · 15 open or blocked of 304 horizon rows** (proof status: [`docs/OWNER_TASKS.md`](docs/OWNER_TASKS.md) → Production-verification checklist) · source commit `11e043a47b7b`. Full data: [`project-status.json`](project-status.json).
