...
![Backend tests](https://img.shields.io/badge/backend_tests-4882-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,882** · frontend **234** · mobile **83**. Route surface: **392**.
...
Generated status: **v0.11.0** · backend **4,882** · frontend **234** · mobile **83** · **392** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `29ec74489151`. Full data: [`project-status.json`](project-status.json).
