...
![Backend tests](https://img.shields.io/badge/backend_tests-5175-brightgreen?logo=pytest)
...
Generated test matrix: backend **5,175** · frontend **364** · mobile **90**. Route surface: **398**.
...
Generated status: **v0.11.0** · backend **5,175** · frontend **364** · mobile **90** · **398** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `ae188ca07a0d`. Full data: [`project-status.json`](project-status.json).
