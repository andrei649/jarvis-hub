...
![Backend tests](https://img.shields.io/badge/backend_tests-5606-brightgreen?logo=pytest)
...
Generated test matrix: backend **5,606** · frontend **386** · mobile **96**. Route surface: **404**.
...
Generated status: **v0.11.0** · backend **5,606** · frontend **386** · mobile **96** · **404** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `78fcc88c79ef`. Full data: [`project-status.json`](project-status.json).
