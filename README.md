...
![Backend tests](https://img.shields.io/badge/backend_tests-5147-brightgreen?logo=pytest)
...
Generated test matrix: backend **5,147** · frontend **365** · mobile **93**. Route surface: **399**.
...
Generated status: **v0.11.0** · backend **5,147** · frontend **365** · mobile **93** · **399** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `80f286a2caa2`. Full data: [`project-status.json`](project-status.json).
