...
![Backend tests](https://img.shields.io/badge/backend_tests-7324-brightgreen?logo=pytest)
...
Generated test matrix: backend **7,324** · frontend **932** · mobile **110**. Route surface: **442**.
...
Generated status: **v1.0.0** · backend **7,324** · frontend **932** · mobile **110** · **442** routes · **18** active agents · open release gates: **A1, A3, A4, A6** · backlog: **254 done · 33 delivered (runtime proof pending) · 14 open or blocked of 301 horizon rows** · source commit `b96b859b1eb6`. Full data: [`project-status.json`](project-status.json).
