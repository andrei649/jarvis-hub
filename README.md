...
![Backend tests](https://img.shields.io/badge/backend_tests-9250-brightgreen?logo=pytest)
...
Generated test matrix: backend **9,250** · frontend **1,035** · mobile **135**. Route surface: **474**.
