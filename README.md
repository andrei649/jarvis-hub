...
![Backend tests](https://img.shields.io/badge/backend_tests-4280-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,280** · frontend **208** · mobile **55**. Route surface: **368**.
...
Generated status: **v0.11.0** · backend **4,280** · frontend **208** · mobile **55** · **368** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `95a6ab28be7d`. Full data: [`project-status.json`](project-status.json).
