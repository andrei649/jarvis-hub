...
![Backend tests](https://img.shields.io/badge/backend_tests-7244-brightgreen?logo=pytest)
...
Generated test matrix: backend **7,244** · frontend **927** · mobile **110**. Route surface: **442**.
...
Generated status: **v1.0.0** · backend **7,244** · frontend **927** · mobile **110** · **442** routes · **18** active agents · open release gates: **A1, A3, A5, A6, A9** · source commit `9f31a50b0cf3`. Full data: [`project-status.json`](project-status.json).
