...
![Backend tests](https://img.shields.io/badge/backend_tests-7051-brightgreen?logo=pytest)
...
Generated test matrix: backend **7,051** · frontend **608** · mobile **96**. Route surface: **419**.
...
Generated status: **v0.11.0** · backend **7,051** · frontend **608** · mobile **96** · **419** routes · **18** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `a5916fd6b96d`. Full data: [`project-status.json`](project-status.json).
