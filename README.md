...
![Backend tests](https://img.shields.io/badge/backend_tests-5178-brightgreen?logo=pytest)
...
Generated status: **v0.11.0** · backend **5,178** · frontend **366** · mobile **90** · **398** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `0ed92264f7ed`. Full data: [`project-status.json`](project-status.json).
