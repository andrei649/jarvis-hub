...
![Backend tests](https://img.shields.io/badge/backend_tests-5127-brightgreen?logo=pytest)
...
Generated test matrix: backend **5,127** · frontend **363** · mobile **90**. Route surface: **398**.
...
Generated status: **v0.11.0** · backend **5,127** · frontend **363** · mobile **90** · **398** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `173adbf77cf8`. Full data: [`project-status.json`](project-status.json).
