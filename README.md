...
![Backend tests](https://img.shields.io/badge/backend_tests-4523-brightgreen?logo=pytest)
...
Generated test matrix: backend **4,523** · frontend **219** · mobile **65**. Route surface: **376**.
...
Generated status: **v0.11.0** · backend **4,523** · frontend **219** · mobile **65** · **376** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8** · source commit `99fa8b4e0006`. Full data: [`project-status.json`](project-status.json).
