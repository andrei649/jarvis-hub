...
![Backend tests](https://img.shields.io/badge/backend_tests-5360-brightgreen?logo=pytest)
...
Generated test matrix: backend **5,360** · frontend **373** · mobile **96**. Route surface: **400**.
...
Generated status: **v0.11.0** · backend **5,360** · frontend **373** · mobile **96** · **400** routes · **17** active agents · open release gates: **A1, A2, A3, A4, A5, A6, A7, A8, A9** · source commit `f92474fe9b9f`. Full data: [`project-status.json`](project-status.json).
