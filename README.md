...
![Backend tests](https://img.shields.io/badge/backend_tests-8574-brightgreen?logo=pytest)
...
Generated test matrix: backend **8,574** · frontend **997** · mobile **110**. Route surface: **462**.
...
Generated status: **v1.0.0** · backend **8,574** · frontend **997** · mobile **110** · **462** routes · **18** active agents · open release gates: **A1, A3, A4, A6** · backlog: **250 done · 38 delivered (runtime proof pending) · 13 open or blocked of 301 horizon rows** · source commit `c16d84e989ff`. Full data: [`project-status.json`](project-status.json).
