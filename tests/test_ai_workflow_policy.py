...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            lambda policy: policy["evidence_receipt"]["reuse"].update(requires_same_head_sha=False),
            "evidence_receipt.reuse.requires_same_head_sha must be true",
        ),
        (
            lambda policy: policy["change_control"].update(direct_push_to_default_branch=True),
