...
def test_live_registry_offers_web_and_memory_tools_to_the_owner_and_never_to_an_inbound_guest(
    ...
    # A stranger on an inbound channel still sees only the two harmless defaults, plus the
    # session-local checklist (H315), whose only effect is the stranger's own session list.
