...
The planned automated receipt runner maps CI risk conservatively: `low -> R0`, `medium -> R2`,
`high -> R3`. Until that bounded tooling successor is accepted, complete the receipt below
directly. `R1` remains available for a justified bounded-internal human classification.
