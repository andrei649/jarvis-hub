...
describe('DecisionInboxPanel — the north-star resolve action is live', () => {
  ...
  it('shows an image prompt without exposing approval internals or editing its bound JSON', async () => {
    const fn = mockFetch({ tasks: [{ id: 17, kind: 'toolrpc.image_generate', title: 'Local image',
      risk_tier: 2, status: 'blocked', payload: { tool: 'image_generate', args: {
