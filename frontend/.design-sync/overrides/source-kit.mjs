// forked from design-sync lib/source-kit.mjs — exclude the Vite app bootstrap
// (src/main.tsx calls createRoot(...).render at module top level; included in
// the synth entry it mounts the whole HUD app into every preview card).
//
...
// fork: app bootstrap modules with mount side effects — never in the synth entry.
const NON_IMPL_RX = /\.(stories|test|spec)\.|(?:^|[\\/])src[\\/]main\.tsx$/;
