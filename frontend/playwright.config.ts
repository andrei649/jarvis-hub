...
export default defineConfig({
  ...
  projects: [
    ...(BROWSER_MATRIX ? [
      { name: 'chromium', testIgnore: [FOOTAGE_SPEC, '**/base-path.spec.ts', '**/appearance.spec.ts', '**/composer-images.spec.ts', '**/media-gallery.spec.ts'], use: { ...devices['Desktop Chrome'] } },
      { name: 'firefox', testIgnore: [FOOTAGE_SPEC, '**/base-path.spec.ts', '**/appearance.spec.ts', '**/composer-images.spec.ts', '**/media-gallery.spec.ts'], use: { ...devices['Desktop Firefox'] } },
      { name: 'webkit', testIgnore: [FOOTAGE_SPEC, '**/base-path.spec.ts', '**/appearance.spec.ts', '**/composer-images.spec.ts', '**/media-gallery.spec.ts'], use: { ...devices['Desktop Safari'] } },
      { name: 'mobile-chrome', testIgnore: [FOOTAGE_SPEC, '**/base-path.spec.ts', '**/appearance.spec.ts', '**/composer-images.spec.ts', '**/media-gallery.spec.ts'], use: { ...devices['Pixel 5'] } },
    ] : [
      { name: 'chromium', testIgnore: [FOOTAGE_SPEC, '**/base-path.spec.ts', '**/appearance.spec.ts', '**/composer-images.spec.ts', '**/media-gallery.spec.ts'], use: { ...devices['Desktop Chrome'] } },
    ]),
