...
const { Icon, ICONS, Glyph, Reactor, Meter, statusClass, fmtTime, fmtTimeShort, fmtDate, renderRich } = window;
...
Object.assign(window, { MODES, TopBar, Ticker, Rail, Tabs, ContextColumn, RosterColumn, Palette, Ambient });
