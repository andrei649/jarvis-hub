...
python -m pytest tests/ -v          # 2093 passed, 1 skipped
```
...
## ORIZONT 20 — Hermes Mining (capabilități nete din `hermes-agent`, post-1.0) — 4/6
