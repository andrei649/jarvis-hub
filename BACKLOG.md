...
python -m pytest tests/ -v          # 1838 passed, 1 skipped
```
...
| **H12 Asistent Privat & Proactiv** (P0–P3) | 25 | **13** | 150 | **61** | **41%** |
| **H13–H17 Frontiere Noi** (post-paritate, în scope v1.0, P1–P3) | 20 | **14** | 146 | **99** | **68%** |
| **Total H1–H17 = scope 1.0.0** | **196** | **173** | **1119** | **918** | **82%** (SP) |
...
> `%` = procent pe **story points**. Sub-total **H1–H11** = 758/823 (≈92% SP; 146/151 iteme). Grand-total **H1–H17** = 918/1119 (≈82% SP; 173/196 iteme). **Gate-ul 1.0.0 = tot backlogul terminat: H10 + H11 + H12 + H13–H17** (toate în scope-ul v1.0 — [#52]). În afara gate-ului: **H18** mobil (9/10) și **H19 WorldView** (33/33 ✅, stack standalone) — livrate.
...
**Test count (backend pytest):** 1,838 passed, 1 skipped — skip-ul rămas e heartbeat-ul opțional (`tests/test_spotify.py` eliminat în CLN-1). *(2026-06-09: backlog software **code-complete** — H10 29/30, H12 13/25, frontiere H13–H17 14/20 (vezi „Status General" de mai sus); + WorldView O19 33/33 merged + Argus. Rămâne audit + testare manuală, vezi `docs/AUDIT.md`.)*
