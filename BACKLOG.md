...
| **0.19.0 ⚠️** | Reach, quality & user docs | mobile parity tail (H18); **quality gates** (E2E, load/soak, a11y, i18n, browser+mobile matrix); **user docs** (USER_GUIDE, FAQ, UPGRADE — *trust docs ✅ H23.19: THREAT_MODEL + PRIVACY + SECURITY + NOTICE/SBOM*); **onboarding wizard** + activation funnel + cold-start error guidance |
