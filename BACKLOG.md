...
state. `tests/test_signals_router.py` (+11) + `frontend/src/test/signal-routing-panel.test.tsx`
(+3); route/OpenAPI/route-auth snapshots reseeded (413 routes). | — |
