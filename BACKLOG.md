...
> **Stare:** 3/10 livrate (H22.1–3, **PR #264**) + **Wave A repo-side done** (H22.4/H22.7/H22.8 🟡 —
> cod/docs livrate, doar acțiuni host rămase: install plugin, install binar, validare GPU).
> Secvență: ✅ **Wave A** (H22.7/H22.8/H22.4) → **Wave B** H22.10 (securitate, gate pre-1.0) →
> **Wave C** H22.5/H22.6/H22.9.
