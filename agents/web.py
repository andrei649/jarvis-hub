...
@asynccontextmanager
async def _turn_lease(orchestrator, session_id=None):
    ...
    if lease is None:
        yield True
        return
    async with (lease(session_id) if session_id is not None else lease()) as acquired:
        yield acquired
...
class ChatRequest(BaseModel):
    # Unknown fields still fail; explicit sessions are validated and hydrated.
...
from agents.core.routers.market_watchlist import router as _market_watchlist_router  # noqa: E402
...
from agents.core.routers.system_profiles import router as _system_profiles_router  # noqa: E402
...
from agents.core.routers.commands import router as _commands_router  # noqa: E402
...
from agents.core.routers.system_map import router as _system_map_router  # noqa: E402
...
app.include_router(_system_map_router)
