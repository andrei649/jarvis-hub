...
DEFAULTS: list[dict[str, Any]] = [
    ...
    dict(category="llm", key="compatible_provider", value="", label="Compatible cloud provider (empty = Gemini)", kind="select", opts=["", "openrouter", "openai-compatible", "openai-responses"]),
