...
_REFINE_REFUSALS = {
    ...
    "daily_budget_cut_off": ("Today's review budget went to reviews the local model cut off or could not "
                             "finish; raise learning.review_max_tokens rather than the budget, or try "
                             "again tomorrow."),
