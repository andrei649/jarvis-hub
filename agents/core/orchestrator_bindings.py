...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1100, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 964, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 965, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 897, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1218, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1240, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1261, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1281, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1301, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1455, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1472, 8),),
        "last_memory_maintenance": (("agents/core/scheduler_service.py", 448, 8),),
        "channel_inbox": (("agents/web.py", 435, 4),),
        "oracle_bridge": (("agents/core/plugin_manager.py", 151, 8),),
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1354, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1375, 12),),
        "argus": (("agents/core/plugin_manager.py", 197, 8),),
