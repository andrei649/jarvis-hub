...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1146, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 996, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 997, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 915, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1264, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1286, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1307, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1327, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1347, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1501, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1518, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1400, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1421, 12),),
