...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 836, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 837, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 802, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1040, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1062, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1083, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1103, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1123, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1272, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1289, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1171, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1192, 12),),
