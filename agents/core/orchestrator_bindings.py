...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 475, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 485, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 486, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 588, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 605, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 626, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 646, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 666, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 727, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 740, 8),),
