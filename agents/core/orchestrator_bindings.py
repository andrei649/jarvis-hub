...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1098, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 962, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 963, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 888, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1216, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1238, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1259, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1279, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1299, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1453, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1470, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1352, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1373, 12),),
