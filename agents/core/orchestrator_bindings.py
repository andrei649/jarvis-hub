...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1088, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 952, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 953, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 888, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1206, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1228, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1249, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1269, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1289, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1443, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1460, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1342, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1363, 12),),
