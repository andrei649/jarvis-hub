...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 711, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 722, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 723, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 856, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 878, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 899, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 919, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 939, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1084, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1101, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 983, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1004, 12),),
