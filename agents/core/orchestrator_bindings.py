...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 594, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 604, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 605, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 731, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 748, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 769, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 789, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 809, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 874, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 887, 8),),
