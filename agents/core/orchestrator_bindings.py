...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "writeback": (("agents/core/autonomy_coordinator.py", 1063, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1085, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1106, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1126, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1146, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1295, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1312, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1194, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1215, 12),),
