...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 780, 8),),
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1000, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 864, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 865, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 830, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1118, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1140, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1161, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1181, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1201, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1350, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1367, 8),),
        "last_memory_maintenance": (("agents/core/scheduler_service.py", 448, 8),),
        "channel_inbox": (("agents/web.py", 391, 4),),
        "oracle_bridge": (("agents/core/plugin_manager.py", 146, 8),),
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1249, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1270, 12),),
