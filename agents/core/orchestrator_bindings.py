...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 558, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 568, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 569, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 695, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 712, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 733, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 753, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 773, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 838, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 851, 8),),
