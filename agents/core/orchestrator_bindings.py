...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 738, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 769, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 770, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 925, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 947, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 968, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 988, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1008, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1153, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1170, 8),),
        "last_memory_maintenance": (("agents/core/scheduler_service.py", 448, 8),),
        "channel_inbox": (("agents/web.py", 354, 4),),
        "oracle_bridge": (("agents/core/plugin_manager.py", 146, 8),),
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1052, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1073, 12),),
