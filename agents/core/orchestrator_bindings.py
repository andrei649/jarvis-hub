...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 716, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 717, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 850, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 872, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 893, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 913, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 933, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1078, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1095, 8),),
        "last_memory_maintenance": (("agents/core/scheduler_service.py", 436, 8),),
        "channel_inbox": (("agents/web.py", 348, 4),),
        "oracle_bridge": (("agents/core/plugin_manager.py", 146, 8),),
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 977, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 998, 12),),
        "argus": (("agents/core/plugin_manager.py", 192, 8),),
        "company_runtime": (("agents/core/scheduler_service.py", 314, 12),),
    }
)
