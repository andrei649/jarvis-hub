...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 844, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 845, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 810, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1048, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1070, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1091, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1111, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1131, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1280, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1297, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1179, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1200, 12),),
