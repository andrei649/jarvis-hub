...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 712, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 742, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 743, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 876, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 898, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 919, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 939, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 959, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1104, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1121, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1003, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1024, 12),),
