...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 835, 8),),
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1114, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 978, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 979, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 897, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1232, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1254, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1275, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1295, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1315, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1469, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1486, 8),),
        "last_memory_maintenance": (("agents/core/scheduler_service.py", 467, 8),),
        "channel_inbox": (("agents/web.py", 483, 4),),
        "oracle_bridge": (("agents/core/plugin_manager.py", 144, 8),),
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1368, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1389, 12),),
        "argus": (("agents/core/plugin_manager.py", 190, 8),),
        "company_runtime": (("agents/core/scheduler_service.py", 345, 12),),
    }
)
