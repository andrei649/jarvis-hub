...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "writeback": (("agents/core/autonomy_coordinator.py", 940, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 962, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 983, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1003, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1023, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1172, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1189, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1071, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1092, 12),),
