...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1078, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 942, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 943, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 888, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1196, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1218, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1239, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1259, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1279, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1433, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1450, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1332, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1353, 12),),
