...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 443, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 453, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 454, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 556, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 573, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 594, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 614, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 634, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 695, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 708, 8),),
