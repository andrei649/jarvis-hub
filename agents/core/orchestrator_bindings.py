...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 853, 8),),
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1162, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 1012, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 1013, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 915, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1280, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1302, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1323, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1343, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1363, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1517, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1534, 8),),
        "last_memory_maintenance": (("agents/core/scheduler_service.py", 474, 8),),
        "channel_inbox": (("agents/web.py", 490, 4),),
        "oracle_bridge": (("agents/core/plugin_manager.py", 144, 8),),
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1416, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1437, 12),),
        "argus": (("agents/core/plugin_manager.py", 190, 8),),
        "company_runtime": (("agents/core/scheduler_service.py", 352, 12),),
    }
)
...
class ExternalOrchestratorBindings(Protocol):
    ...
    work_runs: Any | None
    company_runtime: Any | None
    session_kernels: Any | None
