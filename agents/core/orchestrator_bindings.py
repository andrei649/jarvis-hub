...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 784, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 785, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 949, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 971, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 992, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1012, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1032, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1181, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1198, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1080, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1101, 12),),
