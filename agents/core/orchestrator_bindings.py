...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 519, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 529, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 530, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 656, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 673, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 694, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 714, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 734, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 799, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 812, 8),),
