...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 753, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 801, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 802, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 966, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 988, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1009, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1029, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1049, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1198, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1215, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1097, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1118, 12),),
