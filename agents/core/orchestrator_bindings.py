...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 743, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 744, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 877, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 899, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 920, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 940, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 960, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1105, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1122, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1004, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1025, 12),),
