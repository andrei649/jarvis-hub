...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 760, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 831, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 832, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 802, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1035, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1057, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1078, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1098, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1118, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1267, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1284, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1166, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1187, 12),),
