...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "writeback": (("agents/core/autonomy_coordinator.py", 1043, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1065, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1086, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1106, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1126, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1275, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1292, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1174, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1195, 12),),
