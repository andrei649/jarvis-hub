...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "acquisition": (("agents/core/autonomy_coordinator.py", 858, 8),),
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1167, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 1017, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 1018, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 920, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1285, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1307, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1328, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1348, 8),),
        "node_mesh": (("agents/core/autonomy_coordinator.py", 1368, 8),),
        "subagents": (("agents/core/autonomy_coordinator.py", 1522, 8),),
        "task_executor": (("agents/core/autonomy_coordinator.py", 1539, 8),),
        ...
        "permission_ledger": (("agents/core/autonomy_coordinator.py", 1421, 12),),
        "work_runs": (("agents/core/autonomy_coordinator.py", 1442, 12),),
