...
EXTERNAL_BINDING_WRITERS: Mapping[str, tuple[ExternalBindingCallsite, ...]] = MappingProxyType(
    {
        ...
        "cloud_images": (("agents/core/autonomy_coordinator.py", 1173, 8),),
        "tool_rpc": (("agents/core/autonomy_coordinator.py", 1023, 8),),
        "agent_tool_runtime": (("agents/core/autonomy_coordinator.py", 1024, 8),),
        "session_kernels": (("agents/core/autonomy_coordinator.py", 920, 8),),
        "writeback": (("agents/core/autonomy_coordinator.py", 1291, 8),),
        "social": (("agents/core/autonomy_coordinator.py", 1313, 8),),
        "channel_replies": (("agents/core/autonomy_coordinator.py", 1334, 8),),
        "call_broker": (("agents/core/autonomy_coordinator.py", 1354, 8),),
