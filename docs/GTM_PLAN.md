...
- **Taglines to A/B** (specific vs emotional — the one trade-off the research couldn't resolve for our ICP):
  - B (spine): *"18 agents. One system. Your data stays home."*
  - A (hook, governance-qualified): *"18 agents working while you sleep — one system, every action logged, your data never leaves home."*
