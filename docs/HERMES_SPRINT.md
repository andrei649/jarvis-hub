...
| K2 — interpreter rezident pe sesiune (H660/H305/H595/H287) | în curs | Starea persistă între celule, permisiunea nu: fiecare celulă releagă autoritatea K0, trece prin Action Kernel, primește propria cutie poștală și recitește ESTOP. Kernelul remote și K3 rămân; containerul nu e probat aici. |

Cele opt PR-uri #1061–#1068 raportate la încheierea lucrului sunt toate integrate, la
fel și livrările #1070–#1076 din sprintul curent.
...
4. **Execuție de cod:** K0, K1 și K2 sunt livrate — autoritatea rulării, `execute_code`
   pe suprafața de unelte, apoi interpretorul rezident pe sesiune (toate implicit
   oprite). Rămân kernelul remote, K3 (controale de operator + dovadă pe gazdă) și
