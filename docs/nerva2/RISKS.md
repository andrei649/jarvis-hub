...
| `MEM-03` | Similarity-only retrieval admits irrelevant, stale, private or instruction-bearing memory. | HIGH | CRITICAL | OPEN | Current fused recall is `MIXED`; Continuity Core #731 identifies the missing trust/admission gate. | Admission decision with subject, time, provenance, contradiction, privacy, taint and abstention reason; cross-topic/person tests. | E3/E6/E12 |
