...
| **Hermes Agent** | **no public API contract found** (primary-verified in accepted E8.1a; re-verified 2026-08-08: [E8.1 refresh](EXECUTION_PROVIDER_E8_1_REFRESH_2026-08-08.md). Upstream has since released `v2026.8.27` — skills pin only, see the [2026-08-28 delta port](../research/2026-08-28-hermes-v2026.8.27-delta-port.md) — while the execution-provider pin stays at `v2026.8.3` / `3c27eb6`) | argues for thin adapters everywhere, not deep coupling |
