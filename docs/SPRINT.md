...
**Data:** 2026-07-06 (M3.5 WorldView MCP write transport merged)
...
**Branch:** `codex-docs-m35-worldview-mcp-merged`
...
No active PR locks after #594 merge. Docs sync is on `codex-docs-m35-worldview-mcp-merged`.
