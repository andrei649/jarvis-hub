...
**Data:** 2026-07-05 (R2 taint propagation teeth in draft PR #580)
...
**Branch:** `codex-r2-taint-propagation-teeth`
...
| R2 / Taint Propagation Teeth | `codex-r2-taint-propagation-teeth` | #580 | 🟡 draft PR | Codex | Worker intake/edit taint + user-turn memory metadata + recall provenance |
...
Draft PR #580 owns `agents/core/autonomy/worker.py`, `agents/core/autonomy/queue.py`, `agents/core/memory/manager.py`, `agents/core/orchestrator.py`, `agents/core/security/rag_guard.py`, `tests/test_r2_taint_propagation.py`, `BACKLOG.md`, `STATUS.md`, `docs/SPRINT.md`, and the R2 design/plan docs until it merges.
