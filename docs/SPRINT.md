...
**Data:** 2026-07-06 (AUD-14 CORS-origins env-list merged)
...
**Branch:** `codex-docs-aud14-cors-origins-merged`
...
No active PR locks after #618. Docs sync is on `codex-docs-aud14-cors-origins-merged`.
