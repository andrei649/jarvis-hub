...
**Branch:** `codex-mobile-tasks-board`
...
| H18.13 / Mobile Tasks Board | `codex-mobile-tasks-board` | draft pending | ⏳ in progress | Codex | Native Tasks tab reads `/tasks`, shows state counts, and keeps empty queues honest |
...
Active branch lock: `mobile/App.tsx`, `mobile/src/api/client.ts`, `mobile/src/api/__tests__/tasks.test.ts`, `mobile/src/screens/TasksScreen.tsx`, `mobile/PARITY.md`, `mobile/README.md`, `BACKLOG.md`, `STATUS.md`, `docs/SPRINT.md`, and the H18.13 superpowers spec/plan docs.
