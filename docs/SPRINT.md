...
**Data:** 2026-07-05 (R1/R4 Oracle + MCP host-exec gate)
...
**Branch:** `codex-r1-oracle-mcp-host-exec-gate` (draft PR #578)
...
| R1/R4 / Oracle + MCP Host-Exec Gate | `codex-r1-oracle-mcp-host-exec-gate` | #578 | 🟡 draft PR | Codex | Oracle repo-sync contract/kernel gate + MCP argv/no-shell + MCP tool-call contract |
...
Draft PR #578 owns `agents/core/plugins/oracle_bridge.py`, `agents/core/mcp/client.py`, `agents/core/kernel/registry.py`, `tests/test_oracle_mcp_host_exec_gate.py`, `tests/test_action_auth_matrix.py`, `tests/_snapshots/action_auth.json`, `BACKLOG.md`, `STATUS.md`, `docs/SPRINT.md`, and the matching design/plan docs until it merges.
