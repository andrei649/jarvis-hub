...
**Data:** 2026-07-05 (R3-B4 MCP route-tool contracts active/local green)
...
**Branch:** `codex-r3-b4-mcp-route-tool-contracts`
...
**Active R3-B4 scope:** draft PR #586 (`codex-r3-b4-mcp-route-tool-contracts`) adds `MCP_MUTATING_ROUTE_CONTRACT` before mutating MCP route-tool adapters run. Local red/green and adjacent MCP/contract sweeps are green; CI pending.
...
| R3-B4 / MCP Route-Tool Contracts | `codex-r3-b4-mcp-route-tool-contracts` | #586 | 🟡 draft PR | Codex | Mutating MCP route tools evaluate a reusable contract before kernel/adapters; CI pending |
...
Active branch locks: `agents/core/mcp/route_tools.py`, `tests/test_r3_b4_mcp_route_tool_contracts.py`, `docs/superpowers/specs/2026-07-05-r3-b4-mcp-route-tool-contracts-design.md`, `docs/superpowers/plans/2026-07-05-r3-b4-mcp-route-tool-contracts.md`, `BACKLOG.md`, `STATUS.md`, `docs/SPRINT.md`.
