...
**Data:** 2026-07-05 (R3-B2 memory/forget contracts in draft PR #582)
...
**Branch:** `codex-r3-b2-memory-forget-contracts`
...
| R3-B2 / Memory + Forget Contracts | `codex-r3-b2-memory-forget-contracts` | #582 | 🟡 draft PR | Codex | KG write contract + destructive purge contract |
...
Draft PR #582 owns `agents/core/routers/memory_kg.py`, `agents/core/data_purge.py`, `agents/core/routers/backup.py`, `tests/test_r3_b2_memory_forget_contracts.py`, `BACKLOG.md`, `STATUS.md`, `docs/SPRINT.md`, and the R3-B2 design/plan docs until it merges.
