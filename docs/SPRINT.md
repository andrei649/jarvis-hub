...
**Data:** 2026-07-05 (post-#557)
**Lead agent / Conductor:** Codex
**Obiectiv sesiune:** execute Fable audit safety hardening, fix eval workflow fallout, wire LivingMemory into live recall, finish the DailyReflector sleep-time memory seam, make bounded core memory visible to agents, persist core/tier memory, then keep explicit user-forget complete for those durable cognition stores.
**Branch:** `codex-cognition-forget-purge`
...
| H21.3 / Cognition Forget Purge | `codex-cognition-forget-purge` | #558 | 🟡 draft PR | Codex | Explicit user-forget clears durable LivingMemory core/tier state live and at rest |
...
`codex-cognition-forget-purge` currently owns
`agents/core/cognition/memory.py`, `agents/core/data_purge.py`,
`tests/test_data_purge_memory.py`,
`docs/superpowers/specs/2026-07-05-cognition-forget-purge-design.md`,
`docs/superpowers/plans/2026-07-05-cognition-forget-purge.md`,
...
Current backlog state: **0.45 High-Risk Automation Contracts — payment + signal + plugin + social + write-back + outbound call + Tool-RPC + NodeMesh + media-generation + desktop-step + B1 skill/host-control live gate adoption** is merged in #529/#531/#533/#535/#537/#539/#541/#543/#545/#547/#550. Safe Comms channel inbox transport v0 is delivered in #551; eval-nightly parser hotfix #552 is merged; H21.3 live recall integration is merged in #553; H21.3 DailyReflector durable LivingMemory handoff is merged in #554; H21.3 core prompt injection is merged in #555; H21.3 core persistence is merged in #556; H21.3 tier persistence is merged in #557. Remaining TASK-2/O26 tail is owner live-data/plugin setup plus non-v0 inbox channels. Active WIP is #558 H21.3 cognition forget-purge completeness.
