...
| H21.3 / Recall Reactivation | `codex-living-recall-reactivation` | — | ⏳ in progress | Codex | Matched recall hits refresh LivingMemory tier activation + decay access ledger |
