...
**Data:** 2026-07-06 (AUD-14 email-port env-int merged)
...
**Branch:** `codex-docs-aud14-email-ports-merged`
...
No active PR locks after #610 merge. Docs sync is on `codex-docs-aud14-email-ports-merged`.
