...
**Data:** 2026-07-06 (AUD-14 vector-dimension env-int merged)
...
**Branch:** `codex-docs-aud14-vector-dimension-merged`
...
No active PR locks after #612 merge. Docs sync is on `codex-docs-aud14-vector-dimension-merged`.
