...
**Data:** 2026-07-06 (AUD-14 plugin-grants env-list merged)
...
**Branch:** `codex-docs-aud14-plugin-grants-merged`
...
No active PR locks after #620. Docs sync is on `codex-docs-aud14-plugin-grants-merged`.
