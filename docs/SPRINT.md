...
**Data:** 2026-07-06 (AUD-14 log rotation env-int merged)
...
**Branch:** `codex-docs-aud14-log-merged`
...
No active PR locks after #604 merge. Docs sync is on `codex-docs-aud14-log-merged`.
