...
**Data:** 2026-07-06 (AUD-14 STT beam-size env-int merged)
...
**Branch:** `codex-docs-aud14-stt-merged`
...
No active PR locks after #602 merge. Docs sync is on `codex-docs-aud14-stt-merged`.
