...
**Data:** 2026-07-05 (H18.17 draft PR)
...
**Branch:** `codex-mobile-knowledge-graph` (H18.17 draft PR #574)
...
| H18.17 / Mobile Knowledge Graph | `codex-mobile-knowledge-graph` | #574 | 🟡 draft PR | Codex | Memory tab Graph view reads `/api/kg/*`; read-only |
...
Draft PR #574 owns `mobile/src/api/client.ts`, `mobile/src/api/__tests__/knowledgeGraph.test.ts`, `mobile/src/screens/MemoryScreen.tsx`, `mobile/PARITY.md`, `mobile/README.md`, `BACKLOG.md`, `STATUS.md`, `docs/SPRINT.md`, and H18.17 plan/design docs until it is merged.
