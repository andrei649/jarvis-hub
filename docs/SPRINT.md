...
| AUD-14 / Trust Env-Flags | `codex-aud14-trust-env-flags` | #622 | ✅ merged | Codex | Trust-status mic/strict-local reads use shared `env_flag`; full PR CI green |
