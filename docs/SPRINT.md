...
**Data:** 2026-07-06 (AUD-14 channel-rates env-map merged)
...
**Branch:** `codex-docs-aud14-channel-rates-merged`
...
No active PR locks after #608 merge. Docs sync is on `codex-docs-aud14-channel-rates-merged`.
