...
| H18.12 / Mobile Channel Inbox | `codex-mobile-channel-inbox` | draft pending | ⏳ in progress | Codex | Native Comms tab lists Safe Comms threads, reads messages, queues governed replies |
...
Active branch lock: `mobile/App.tsx`, `mobile/src/api/client.ts`, `mobile/src/api/__tests__/channelInbox.test.ts`, `mobile/src/screens/CommsScreen.tsx`, `mobile/PARITY.md`, `mobile/README.md`, `BACKLOG.md`, `STATUS.md`, `docs/SPRINT.md`, and the H18.12 superpowers spec/plan docs.
