...
**Data:** 2026-07-06 (AUD-14 LLM model config merged)
...
**Branch:** `codex-docs-aud14-llm-model-config-merged`
...
No active PR locks after #596 merge. Docs sync is on `codex-docs-aud14-llm-model-config-merged`.
