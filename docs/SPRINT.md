...
**Data:** 2026-07-06 (AUD-14 analytics max-events env-int merged)
...
**Branch:** `codex-docs-aud14-analytics-merged`
...
No active PR locks after #600 merge. Docs sync is on `codex-docs-aud14-analytics-merged`.
