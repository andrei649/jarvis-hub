...
**Data:** 2026-07-06 (AUD-14 channel send-rate env-int merged)
...
**Branch:** `codex-docs-aud14-channel-rate-merged`
...
No active PR locks after #592 merge. Docs-only sync branch touches `BACKLOG.md`, `STATUS.md`, and `docs/SPRINT.md`.
