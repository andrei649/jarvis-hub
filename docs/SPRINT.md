...
**Data:** 2026-07-06 (AUD-14 call-config env-json merged)
...
**Branch:** `codex-docs-aud14-call-config-merged`
...
No active PR locks after #606 merge. Docs sync is on `codex-docs-aud14-call-config-merged`.
