...
| H21.3 / Recall Reactivation | `codex-living-recall-reactivation` | #561 | 🟡 draft PR | Codex | Matched recall hits refresh LivingMemory tier activation + decay access ledger |
...
`codex-living-recall-reactivation` currently owns
`agents/core/cognition/memory.py`, `agents/core/memory/living_recall.py`,
`agents/core/orchestrator.py`, `tests/test_living_memory_recall_eval.py`,
`docs/superpowers/specs/2026-07-05-living-recall-reactivation-design.md`,
`docs/superpowers/plans/2026-07-05-living-recall-reactivation.md`,
