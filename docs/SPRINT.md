...
**Branch:** `codex-docs-mobile-knowledge-graph-merged` (post-merge docs sync)
...
Draft PR #575 (`codex-docs-mobile-knowledge-graph-merged`) owns `BACKLOG.md`, `STATUS.md`, and `docs/SPRINT.md` until this post-merge status correction lands.
