...
> **Why this exists.** The automated suite (1,655 tests) runs fully offline with
...
> with no open ❌ blocker — *plus* the green offline suite (**1,655 passed, 1 skipped**) is what
...
- [ ] `pytest tests/` is green — **1,655 passed, 1 skipped** (the 1 skip is the optional
