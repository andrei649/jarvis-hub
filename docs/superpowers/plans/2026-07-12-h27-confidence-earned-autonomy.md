...
3. Record real terminal outcomes in `AutonomyWorker` and bind its private ledger-backed stats
   provider to policy evaluation (caller payloads never carry trusted confidence).
