...
| B3 | Verification Fabric readiness (`v3-modes2.jsx` AI-OS) | `NEW` Readiness board → Observe | `GET /api/metrics/capabilities` | SEAM→WIRED→VERIFIED→GA ladder from registry; **never fake VERIFIED** (honesty contract #4) | `observe` |
