...
| <a id="h570"></a>H570 | Declare what an extension is allowed to do, and consent to it once | update | Parțial | Reevaluat | Consimtamantul pe hash exista si re-intreaba cu diff la o suprafata schimbata; lipsesc registrul canonic de capabilitati cu fraze de risc, ecranul de consimtamant si declararea prin entry-point-uri pip. [d1](../agents/core/extensions/manifest.py) [d2](../agents/core/extensions/doctor.py) [d3](../docs/EXTENSIONS.md) |
...
| <a id="h615"></a>H615 | Extend the agent with third-party code at lifecycle points (plugin system) | update | Parțial | Reevaluat | Jumatatea de hook-uri ramane deschisa: evenimentele pot fi declarate, dar nu sunt livrate (S3). Lipsesc si legarea comenzilor declarate si middleware-ul. [d1](../agents/core/extensions/manifest.py) [d2](../agents/core/extensions/doctor.py) [d3](../docs/EXTENSIONS.md) |
...
| <a id="h637"></a>H637 | Extend the agent with third-party code without forking it | copy | Parțial | Reevaluat | Din triada manifest+lifecycle+doctor, dispatch-ul exista acum; lipsesc cele 16 hook-uri, middleware-ul, suprafetele de storage, ctx.llm, comenzile CLI/slash aduse de extensie, distributia prin pip si link-urile de instalare. Nedovedit pe un Docker real. [d1](../agents/core/extensions/manifest.py) [d2](../agents/core/extensions/doctor.py) [d3](../docs/EXTENSIONS.md) |
