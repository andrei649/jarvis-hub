...
| `docs/COGNITION.md` | Cognition subsystem (planned ORIZONT 19) — living memory + personality **schematic & diagnostic map** (brain analogies, tiers, troubleshooting playbook) |
