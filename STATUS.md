...
| AUD-14 plugin-grants env-list | 🟡 in progress | `JARVIS_PLUGIN_GRANTS` now uses shared `env_list()` parsing instead of local comma splitting in `plugin_gate.py`; focused plugin-gate checks are green locally. |
