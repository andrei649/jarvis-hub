...
| AUD-14 STT beam-size env-int | 🟡 in progress (#602) | `JARVIS_STT_BEAM_SIZE` now uses shared `env_int(..., minimum=1)` instead of local `int(os.environ...)`; malformed and non-positive values fall back to the greedy decode default. |
