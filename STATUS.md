...
H18.13 mobile tasks parity is implemented on the current branch: the native Tasks tab reads `GET /tasks`, preserves the honest empty state, and renders active/waiting/done counts plus owner/project/state cards.
