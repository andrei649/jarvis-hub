...
| AUD-14 skill-history env-flag | 🟡 in progress | `JARVIS_SKILL_HISTORY` now uses shared `env_flag()` parsing instead of presence-check truthiness in `orchestrator.py`; focused marketplace history suite is green locally. |
