...
O26-P3.6 landing page dev half is in draft PR #512 on `codex-o26-p3-6-landing-dev-half`.
...
| O26-P3.2 HUD punch-list reconciliation | ✅ merged (#507) | `docs/design/HUD_V2_REMAINING.md` now distinguishes shipped controls from real remaining work, and `hud-p3-2-reconciliation.test.ts` pins that shipped TTS/mic/cognition/trust and Console controls are not re-listed as missing. |
