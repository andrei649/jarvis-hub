...
| LivingMemory duplicate encoding gate | 🟡 draft PR (#562) | Exact duplicate completed-turn digests map to zero surprise, skip another LivingMemory tier record, and avoid an extra decay entry. |
