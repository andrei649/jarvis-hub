...
| AUD-14 trust env-flags | 🟡 in progress | `JARVIS_MIC_MUTED` and `JARVIS_STRICT_LOCAL` now use shared `env_flag()` parsing instead of direct router env reads; focused trust/env-config checks are green locally. |
