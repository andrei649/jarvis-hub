...
0.45 High-Risk Automation Contracts now has its first live adoption in #529: `PaymentBroker` evaluates `PAYMENT_CONTRACT` for request and approval admissibility, preserving existing mandate denial codes while moving the gate onto the reusable contract layer.
