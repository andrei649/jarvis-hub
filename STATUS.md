...
O26-P3.4 mobile approval queue is open as draft PR #509.
...
| O26-P3.4 mobile approval queue | 🟡 draft PR #509 | Mobile gains an Approvals tab over the unified autonomy queue, optional `X-Admin-Token` persistence, approve/reject/defer calls, README/PARITY updates, and a mobile API contract test. |
