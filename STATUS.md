...
H18.12 mobile channel inbox parity is implemented on the current branch: the native Comms tab reads Safe Comms inbox threads/messages and queues governed replies back into the existing approval funnel with `source:"mobile"`.
